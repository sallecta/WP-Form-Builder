...
/**
 * Class FRMK_NumberField
 *
 * Add text field
 */
class FRMK_NumberField extends FRMK_FormField {
	...
	public function output( $form_data ) {
		...
		switch ( $this->get_display_type() ) {
			...
			case 'slider':
				...
				echo '<div class="frmk-number--single ' . esc_attr( $this->get_display_type() ) . '">';
			...
			case 'slider-range':
				...
				echo '<div class="frmk-number--range ' . esc_attr( $this->get_display_type() ) . '">';
				...
				if ( 'input-range' === $this->get_display_type() ) {
					echo '<span class="frmk-range-text">to</span>';
				}
	...
	protected function display_slider_element() {
		...
		echo '<div class="frmk-range-slider" data-range="' . esc_attr( $range ) . '" data-min="' . esc_attr( $this->get_min_value() ) . '" data-max="' . esc_attr( $this->get_max_value() ) . '" data-step="' . esc_attr( $this->get_step_value() ) . '"></div>';
	}
