...
/**
 * Class FRMK_FileField
 *
 * Add file field.
 */
class FRMK_FileField extends FRMK_FormField {
	...
	public function output( $form_data ) {
		...
		if ( ! empty( $value ) ) {
			...
			echo sprintf( '<p class="frmk-upload">Uploaded File: <span class="frmk-upload__name">%s</span></p>', esc_html( $value ) );
		}
	}
