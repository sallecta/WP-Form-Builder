 ...
 * Class FRMK_DB_Form
 */
class FRMK_DB_Form extends FRMK_Form {
	...
	public function __construct( $form_id = null ) {
		...
		if ( $post && 'frmk_form' === $post->post_type ) :
			$this->ID = $form_id;
...
//			}
			...
			$this->_theme   = new FRMK_FormTheme( $style, $style_disabled );
			...
			if ( isset( $form['form_label'] ) ) {
				...
				$this->_label = sprintf( 'FRMK_FORM_%d', $this->ID );
			}
