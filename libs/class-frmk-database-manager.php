...
class FRMK_DatabaseManager {
	...
	/**
	 * FRMK_DatabaseManager constructor.
	 */
	public function __construct() {

		global $wpdb;
		$this->_submission_table      = "{$wpdb->prefix}frmk_submissions";
		$this->_submission_data_table = "{$wpdb->prefix}frmk_submission_data";
	}
	 ...
	 * @param FRMK_FormData $data Form data.
	 *
	 * @return bool
	 */
	...
	public function install() {
		...
		$db_version = intval( get_option( 'frmk_db', 0 ) );
